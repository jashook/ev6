...
def main(_VirtualMachine, _Destination, _NumberOfMachines, _StartupFile, _EntryExitScript, _Continue, _Gui = True):
   ...
   if _StartupFile == None:
      ...
      start_machines(_VirtualMachine, _Destination, _NumberOfMachines, _StartupFile, _EntryExitScript, False, _Continue, _Gui)

   elif _StartupFile != None:

      start_machines(_VirtualMachine, _Destination, _NumberOfMachines, _StartupFile, _EntryExitScript, True, _Continue, _Gui)
...
def print_help():
   ...
   print "-gui y or no for whether the gui should be shown"

   print "--help help"

def start_machines(_VirtualMachine, _Destination, _NumberOfMachines, _StartupFile, _ExitFile, _IsStartupFile, _Continue, _Gui):
   ...
   for _Number in range(_NumberOfMachines):
      ...
      if not _IsStartupFile: _ClonedMachine = vmware_create(_VirtualMachine, _NewDir, _NewVmx, _NewVmdk, _CloneMachine, _Continue, _Gui)

      else: vmware_create(_VirtualMachine, _NewDir, _StartupFile, _NewVmx, _NewVmdk, _CloneMachine, _Continue, _Gui)
...
if __name__ == '__main__':
   ...
   if (_Gui == "False" or _Gui == "F" or _Gui == "f"): _Gui = False

   if (_Gui == "T" or _Gui == "t"): _Gui = True

   main(_VirtualMachine, _Destination, _NumberOfMachines, _StartupFile, _Script, _Continue, _Gui)
