...
def continue_execution(_ClonedMachine, _Thread, _CloneMachine, _VirtualMachine = None):
   ...
   while _ContinueLoop is True:
      ...
      _ClonedMachine._m_disk_file = find_last_snapshot(_ClonedMachine)
      ...
      _Command = "sudo mkdir " + "\"" + "/media/hdd0/Virtual Machines/collected/" + _DirUrl + "\""
...
def get_number():
   ...
   if (_CollectionNumber is 0):
      ...
      for _FileName in os.listdir("/media/hdd0/Virtual Machines/collected/"):
