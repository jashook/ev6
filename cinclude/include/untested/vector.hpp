...
// Modifications: 
//
// 22-Jan-13: Version 1.3: Cleaned and updated to namespace ev6
// 29-Dec-12: Version 1.2: Updated to ev5
// 8-Aug-12 : Version 1.1: Added support for stack based allocation for speed
//
// Timeperiod: ev6
//
////////////////////////////////////////////////////////////////////////////////
...
template <typename __Type, std::size_t __Size = 1> class vector
{
   ...
   public:   //   member functions
      ...
      void push_back(value_type __Type) { _push_back(__Type); }
   ...
   public:   // helper functions
      ...
      {
         if (_position >= _m_size) throw std::range_error("array::at _position is out of range");
      ...
      {
         if (!(_is_valid())) throw std::range_error("array::at _m_size is out of range");
