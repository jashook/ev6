...
// Modifications:
//
// 5-Jan-12 : Version 1.1: Cleaned and changed the namespaces
//
// Timeperiod: ev6
//
// Notes: A large portion of this code was written by Jan Shook
//        
//      - Known Bug: the os_calls posix defines are not included with apple's os
...
#ifndef _WIN32
   #define __POSIX_SOURCE             // This application conforms to POSIX.1
   #define __POSIX_C_SOURCE 1995006L   // This application conforms to POSIX.1b and and POSIX.1c
